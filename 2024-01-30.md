...
```sql
           ...
           LEFT OUTER JOIN (
                ...
                SELECT 'UPDATE /** SQLID={...} */' || CHR(13)
                    ...
                    || SUBSTR(XMLAGG(XMLELEMENT(DOS, LPAD(CHR(32), 5, CHR(32)) || ',' || CHR(32)|| TEMP.COLUMN_NAME || CHR(32) || '=' || CHR(32) || '#{' || SUBSTR(REPLACE(INITCAP('1'||TEMP.COLUMN_NAME), '_'), 2) || '}' || CHR(32) || TEMP.STD_COMMENTS || CHR(13), '').EXTRACT('//text()') ORDER BY TEMP.COLUMN_ID).GETCLOBVAL(), 7)
                    || CHR(32) || 'WHERE 1 = 1' || CHR(13)
